...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW0057Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino)
        {
            ...
            jf.New(outputData.GW0057RequestJson.RequestMessageData, outputData.GW0057RequestJson.FileNo, apino, "Request");
        }
            ...
            var outputData = new ResponseJson()
            {
                GW0057ResponseJson = new GW0057ResponseJson()
                {
                    ...
                    ResponseMessageData = new ResponseMessageData()
                    {
                        ...
                        var jf = new JsonFileWriter();
            jf.New(outputData.GW0057ResponseJson.ResponseMessageData, outputData.GW0057ResponseJson.FileNo, apino, "Response");
        }
