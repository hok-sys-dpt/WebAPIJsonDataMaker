...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1025Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino, string outputpath)
        {
            ...
            jf.New(outputData.GW1025RequestJson.RequestMessageData, outputData.GW1025RequestJson.FileNo, apino, "Request", outputpath);
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino, string outputpath)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1025ResponseJson.ResponseMessageData, outputData.GW1025ResponseJson.FileNo, apino, "Response", outputpath);
        }
