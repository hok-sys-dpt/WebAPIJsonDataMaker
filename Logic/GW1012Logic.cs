...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1012Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino)
        {
            ...
            jf.New(outputData.GW1012RequestJson.RequestMessageData, outputData.GW1012RequestJson.FileNo, apino, "Request");
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1012ResponseJson.ResponseMessageData, outputData.GW1012ResponseJson.FileNo, apino, "Response");
        }
