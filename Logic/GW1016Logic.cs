...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1016Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino)
        {
            ...
            jf.New(outputData.GW1016RequestJson.RequestMessageData, outputData.GW1016RequestJson.FileNo, apino, "Request");
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1016ResponseJson.ResponseMessageData, outputData.GW1016ResponseJson.FileNo, apino, "Response");
        }
