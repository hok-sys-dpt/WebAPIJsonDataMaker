...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1001Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino, string outputpath)
        {
            ...
            jf.New(outputData.GW1001RequestJson.RequestMessageData, outputData.GW1001RequestJson.FileNo, apino, "Request", outputpath);
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino, string outputpath)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1001ResponseJson.ResponseMessageData, outputData.GW1001ResponseJson.FileNo, apino, "Response", outputpath);
        }
