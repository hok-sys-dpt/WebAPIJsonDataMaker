...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW0019Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino)
        {
            ...
            jf.New(outputData.GW0019RequestJson.RequestMessageData, outputData.GW0019RequestJson.FileNo, apino, "Request");
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW0019ResponseJson.ResponseMessageData, outputData.GW0019ResponseJson.FileNo, apino, "Response");
        }
