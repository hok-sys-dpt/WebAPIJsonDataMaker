...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1019Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino)
        {
            ...
            jf.New(outputData.GW1019RequestJson.RequestMessageData, outputData.GW1019RequestJson.FileNo, apino, "Request");
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1019ResponseJson.ResponseMessageData, outputData.GW1019ResponseJson.FileNo, apino, "Response");
        }
