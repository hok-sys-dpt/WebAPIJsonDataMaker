...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1018Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino)
        {
            ...
            jf.New(outputData.GW1018RequestJson.RequestMessageData, outputData.GW1018RequestJson.FileNo, apino, "Request");
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1018ResponseJson.ResponseMessageData, outputData.GW1018ResponseJson.FileNo, apino, "Response");
        }
