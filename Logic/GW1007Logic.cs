...
namespace WebAPIJsonDataMaker.Logic
{
    public class GW1007Logic : IGWLogic
    {
        ...
        public void NewRequestJson(RequestCsv data, string apino, string outputpath)
        {
            ...
            jf.New(outputData.GW1007RequestJson.RequestMessageData, outputData.GW1007RequestJson.FileNo, apino, "Request", outputpath);
        }
        ...
        public void NewResponseJson(ResponseCsv data, string apino, string outputpath)
        {
            ...
            var jf = new JsonFileWriter();
            jf.New(outputData.GW1007ResponseJson.ResponseMessageData, outputData.GW1007ResponseJson.FileNo, apino, "Response", outputpath);
        }
