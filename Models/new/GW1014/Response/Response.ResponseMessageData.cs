namespace BankVision.WebAPI.Models.GW1014.Response
{
    using System;
    using System.IO;
    using System.Xml;
    ...
    public class ResponseMessageData : IWisResponseSystemInfo
    {
        ...
        public SenyotozakashikoshiJikkoYoyaku SenyotozakashikoshiJikkoYoyaku;

        public ResponseMessageData()
        {
            WisResponseSystemInfo = new WisResponseSystemInfo();
            SenyotozakashikoshiJikkoYoyaku = new SenyotozakashikoshiJikkoYoyaku();
        }
