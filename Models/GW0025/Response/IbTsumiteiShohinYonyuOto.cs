namespace WebAPIJsonDataMaker.Models.GW0025.Response
{
    public class IbTsumiteiShohinYonyuOto
    {
        ...
        public string shukkinKozaTenmeiKana { get; set; }
        public int shukkinKozaKamokuCode { get; set; }
        public string shukkinKozaKamokumei { get; set; }
